		...
		navigator.geolocation.getCurrentPosition(
			function(pos){
				...
				DatabaseGetImage('map',url,function(img){
					$('#CurrentLocationDisplayImg').html(img+'<small class="text-muted"><i class="fa fa-location-arrow"></i> '+_geolocation.latitude+', '+_geolocation.longitude+' &plusmn; '+pos.coords.accuracy+' m</small>');
				});			
			},
			function(error){
